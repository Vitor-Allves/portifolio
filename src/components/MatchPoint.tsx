...
export default function MatchPoint() {
  ...
  return (
    <section id="match-point" ref={sectionRef} className="relative h-[400vh] bg-navy-950">
      <div className="sticky top-0 h-[100svh] overflow-hidden flex flex-col justify-center text-white">
        ...
        <div className="relative mx-auto w-full max-w-[1400px] px-6 lg:px-10">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <h2 className="mt-4 font-serif text-5xl sm:text-6xl lg:text-7xl tracking-[0.08em]">
              MATCH POINT
            </h2>
            <p className="mt-5 max-w-xl mx-auto text-sm sm:text-base text-silver-400 font-light">
          ...
          <div className="relative h-[280px] sm:h-[320px]">
            {stages.map((stage, i) => (
              <div
                ...
                className={`absolute inset-0 flex flex-col sm:flex-row items-center gap-8 sm:gap-14 transition-opacity duration-700 ease-out ${
                  active === i ? "opacity-100" : "opacity-0 pointer-events-none"
                }`}
              >
                <div className="shrink-0 flex flex-col items-center sm:items-start">
                  <span className="font-serif text-[5.5rem] sm:text-[7rem] leading-none text-silver-300/90">
                    {stage.score}
                  </span>
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="mt-2 text-silver-400 text-sm sm:text-base max-w-md">
                    Objetivo: {stage.goal}
                  </p>
          ...
          <div className="relative mt-6 sm:mt-10">
            ...
            <motion.div
              ...
              aria-hidden="true"
            />
            <div className="mt-4 flex justify-between text-[10px] sm:text-[11px] tracking-[0.2em] uppercase text-silver-600">
              <span>Cenário atual</span>
              <span>Evolução contínua</span>
            </div>
          </div>

          <p className="mt-14 text-center font-serif text-lg sm:text-xl text-silver-300 max-w-lg mx-auto">
